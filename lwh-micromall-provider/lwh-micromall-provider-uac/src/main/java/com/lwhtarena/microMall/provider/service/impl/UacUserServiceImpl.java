...
import com.lwhtarena.microMall.common.core.enums.LogTypeEnum;
import com.lwhtarena.microMall.common.core.support.BaseService;
import com.lwhtarena.microMall.common.core.utils.RequestUtil;
import com.lwhtarena.microMall.common.util.*;
import com.lwhtarena.microMall.provider.manager.UserManager;
import com.lwhtarena.microMall.provider.mapper.UacActionMapper;
import com.lwhtarena.microMall.provider.mapper.UacMenuMapper;
import com.lwhtarena.microMall.provider.mapper.UacUserMapper;
import com.lwhtarena.microMall.provider.mapper.UacUserMenuMapper;
import com.lwhtarena.microMall.provider.model.domain.*;
import com.lwhtarena.microMall.provider.model.dto.menu.UserMenuChildrenDto;
import com.lwhtarena.microMall.provider.model.dto.menu.UserMenuDto;
import com.lwhtarena.microMall.provider.model.dto.user.*;
import com.lwhtarena.microMall.provider.model.enums.UacEmailTemplateEnum;
import com.lwhtarena.microMall.provider.model.enums.UacUserSourceEnum;
import com.lwhtarena.microMall.provider.model.enums.UacUserStatusEnum;
import com.lwhtarena.microMall.provider.model.enums.UacUserTypeEnum;
...
import com.lwhtarena.microMall.provider.model.vo.UserBindRoleVo;
import com.lwhtarena.microMall.provider.mq.producer.EmailProducer;
import com.lwhtarena.microMall.provider.service.*;
import com.lwhtarena.microMall.provider.utils.Md5Util;
import com.lwhtarena.microMall.security.core.SecurityUser;
...
public class UacUserServiceImpl extends BaseService<UacUser> implements UacUserService {
	...
	public void register(UserRegisterDto registerDto) {
		...
		param.put("dateTime", cn.hutool.core.date.DateUtil.formatDateTime(new Date()));
