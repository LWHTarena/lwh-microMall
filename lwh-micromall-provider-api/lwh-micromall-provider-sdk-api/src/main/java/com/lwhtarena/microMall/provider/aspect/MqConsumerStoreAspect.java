package com.lwhtarena.microMall.provider.aspect;
...
import com.lwhtarena.microMall.provider.exceptions.TpcBizException;
import com.lwhtarena.microMall.provider.model.domain.MqMessageData;
import com.lwhtarena.microMall.provider.model.enums.MqMessageTypeEnum;
...
public class MqConsumerStoreAspect {
	 ...
	 */
	@Pointcut("@annotation(com.lwhtarena.microMall.provider.annotation.MqConsumerStore)")
